...
from app.auth import Forbidden, RequiresLogin
...
app = FastAPI(title="MK Timekeeping & Compliance (POC)")
app.add_middleware(
    SessionMiddleware,
    secret_key=os.environ.get("SECRET_KEY", "poc-dev-secret-change-in-azure"),
    same_site="lax",
)
